...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "LSBTest@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "LSBTest API";

        private String description = "LSBTest API documentation";
