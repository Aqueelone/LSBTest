# LSBTest [![Build Status](https://travis-ci.org/Aqueelone/LSBTest.svg)](http://travis-ci.org/Aqueelone/LSBTest)
...
To optimize the LSBTest application for production, run:
